...
Dialog cài đặt giao diện bảng "Khai báo Ca làm việc" (Declare Work Shift).
...
from core.ui_settings import (
    get_declare_work_shift_table_ui,
    update_declare_work_shift_table_ui,
)
...
class DeclareWorkShiftSettingsDialog(QDialog):
    def __init__(self, parent=None) -> None:
        super().__init__(parent)
        logging.getLogger(__name__).info("Open DeclareWorkShiftSettingsDialog")
        self.setModal(True)
        self.setWindowTitle("Cài đặt khai báo ca làm việc")
        ...
        group = QGroupBox("Cài đặt bảng khai báo ca làm việc", self)
        ...
        self._ui = get_declare_work_shift_table_ui()
